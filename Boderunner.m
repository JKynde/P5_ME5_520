...
param=StructCreator();
j = sqrt(-1);
plotmodes = 5; % 1 = F   2 = Z    3 = v     4 = F Matricer2   5 = Z Matricer2   6 = S_VF Matricer2
...
switch plotmodes
    ...
    case 6 %Z_out med sittig/bloomfield
        figure;
        ...
        nexttile
        semilogx(f,abs(S_VF_out)) % skriv enten F_DB, V_DB eller Z_DB
        grid on
        title('Magnitude plot of S_VF_{out}(f)')
